...
- `architecture`: Repository structure, docs, and high-level project shape.
- `setup`: Local setup, scripts, dependencies, and runtime configuration.
- `testing`: Automated tests, fixtures, mocks, and quality gates.
